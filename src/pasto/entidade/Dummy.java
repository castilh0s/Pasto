...
public class Dummy implements Entidade {
	...
	/**
	 * Cria uma nova instância desta classe, com o pasto como seu pasto e uma flag
	 * "vivo" para indicar se é um Dummy móvel ou estático.
	 * 
	...
	/**
	 * Faz as ações relevantes a esta entidade, dependendo de que tipo de entidade
	 * seja.
	 */
	@Override
	public void tick() {
	...
	/**
	 * Testa se esta entidade pode estar na mesma posição no pasto da outra, passada
	 * por parâmetro.
	 */
	@Override
	public boolean eCompativel(Entidade otherEntity) {
		return false;
	}
